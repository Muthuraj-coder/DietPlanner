    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="text-right">
          <div className="mb-2">
            <span className="text-sm text-gray-600">
              Manual generations: {generationCount}/3
            </span>
            ...
            {todayMealPlan?.isAutoGenerated && (
              <div className="text-xs text-blue-600 mt-1">
                ✨ Auto-generated at midnight
              </div>
            )}
          </div>
          <button
          ...
          >
            {loading ? (
              ...
              todayMealPlan ? 'Generate New Plan' : 'Generate Plan'
            ) : (
              'Daily Limit Reached'
            )}
          </button>
      ...
      {initialLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <div className="mb-4">
            <span className="text-sm text-gray-600">
              Manual generations used: {generationCount}/3
            </span>
            {remainingGenerations > 0 && (
              <span className="ml-2 text-sm text-emerald-600 font-medium">
